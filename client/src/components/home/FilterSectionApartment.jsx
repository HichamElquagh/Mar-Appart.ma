...
const FilterSectionApartment = ({FilterData}) => {
  ...
  <div class="mt-10 grid max-w-md grid-cols-1 gap-6 px-2 sm:max-w-lg sm:px-20 md:max-w-screen-xl md:grid-cols-2 md:px-10 lg:grid-cols-2 lg:gap-8">
    ...
    class="mb-4 overflow-hidden rounded-xl border text-gray-700 shadow-md duration-500 ease-in-out hover:shadow-xl">
      ...
      <div class="p-4">
        <div class="pb-6">
          <a href="#" class="text-lg hover:text-green-600 font-medium duration-500 ease-in-out">{apartment.address}, {apartment.city}, USA</a>
        </div>
        ...
        <ul class="m-0 flex list-none items-center justify-between px-0 pt-6 pb-0">
          <li class="text-left">
            ...
            <p class="m-0 text-base font-medium">{apartment.price}</p>
          </li>
...
export default FilterSectionApartment;
